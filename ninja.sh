...
# Function: PRO Stylish Logo (Horizontal & Fixed)
show_logo() {
    clear
    echo -e "${BLUE}"
    # Using cat EOF to prevent backslash errors
    cat << "EOF"
  _   _ ___ _   _     _   _    _____ _   _ _   _ _   _ _____ _
 | \ | |_ _| \ | |   | | / \  |_   _| | | | \ | | \ | | ____| |
 |  \| || ||  \| |_  | |/ _ \   | | | | | |  \| |  \| |  _| | |
 | |\  || || |\  | |_| / ___ \  | | | |_| | |\  | |\  | |___| |___
 |_| \_|___|_| \_|\___/_/   \_\ |_|  \___/|_| \_|_| \_|_____|_____|
EOF
    echo -e "${CYAN}"
    echo " ╔══════════════════════════════════════════════════╗"
    echo " ║           🚀 NINJA TUNNEL - v2.0 PRO           ║"
    echo " ║            Anti-Filter | High Speed            ║"
    echo " ╚══════════════════════════════════════════════════╝"
    echo -e "${NC}"
}
